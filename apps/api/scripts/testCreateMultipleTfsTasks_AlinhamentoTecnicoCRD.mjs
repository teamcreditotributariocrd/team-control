...
const drafts = datasExecucao.map((dataExecucao) => {
  ...
  return createTfsTaskDraft({
    title: `Alinhamento tecnico com a equipe sobre problemas gerais no CRD de integracao e resolucao de causa raiz ${dataBr}`,
    description: "Alinhamento tecnico com a equipe sobre problemas gerais no CRD de integracao e resolucao de causa raiz",
